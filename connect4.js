...
function makeHtmlBoard() {
  ...
  // Creates the HTML elements that make up the top selection part of the board. Adds the column-top id and a click event listener. 
...
//CSS additions for scroll effect
function reveal() {
...
function checkForWin() {
  ...
  // These 2 for loops check a 4X4 square starting with y = 0 and x = 0 and adding 1 to x until x reaches the total width. Then 1 is added to y and the process repeats itself. 
